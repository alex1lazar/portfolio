---
title: "Kota Platform: 2025 in Review"
description: "It was an eventful team for the team working on Kota's platforms for employers and employees. We've grown to 9 people working across three main platforms while adding dozens of improvements and 6 new large integrations."
date: "2025"
tags: ["job","career","startups"]
slug: "kota-2025-in-review"
---

## An improved experience for account administrators
...
![Homescreen / Dashboard](Homescreen)

### Inviting employees to different benefit categories/tiers
...
![Inviting employees to different benefit categories/tiers](Multi category) 

### Flow improvements to benefit creation in Ireland
...
![Improvements to the health and pension creation in Ireland](ILH flow)

### Sending pension documents to authorised person
...
![Allowing authorised person to sync documents via email](Async docs)
...
![Allowing authorised person to sync documents via email](SSO)
...
![Allowing authorised person to sync documents via email](Bulk add)

### People page improvements (paused)
...
![Improvement to the People page for admins](People page)

## Integrations and big features

### Auto Enrolment Acquisition
...
![Auto Enrolment Acquisition flow](AE acquisition)
...
![Auto Enrolment in Ireland](AE Pension)
### Bupa UK
...
![Zurich Pension integration](Zurich)
### Cards (a.k.a Allowance / Spend Cards)
...
![Cards and Allowance spending](Cards) 
### Benefits builder
...
![Employee Web platform](Employee Web)
...
![Vulnerable customers feature](Vulnerable)
### Mobile app reskin
